  ...
  return (
    <section
      ...
      className={`py-20 md:py-32 bg-transparent relative overflow-hidden transition-all duration-1000 ease-[cubic-bezier(0.22,1,0.36,1)] ${
        hasRevealed ? 'opacity-100' : 'opacity-0 translate-y-20'
      }`}
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none opacity-[0.12] select-none">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          {/* Two offer cards — opaque bento */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 max-w-3xl mx-auto mb-10">
            {/* Green card */}
            <div className="sn-warp-tile relative p-6 md:p-8 rounded-xl overflow-hidden text-left transition-colors duration-300 hover:border-[#25D366]/40">
              ...
              <p className="text-gray-400 text-sm mb-5">Compleet in jouw huisstijl of een verbeterde versie daarvan. Binnen 1 week geleverd.</p>
            ...
            {/* Cyan card */}
            <div className="sn-warp-tile relative p-6 md:p-8 rounded-xl overflow-hidden text-left transition-colors duration-300 hover:border-[#00A3E0]/40">
              <div className="absolute top-0 left-0 right-0 h-px" style={{ background: 'linear-gradient(90deg, transparent, #00A3E0, transparent)' }} />
              ...
              <p className="text-gray-400 text-sm mb-5">Complete website met AI-systeem, CRM en analytics. Gratis en vrijblijvend als live demo.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="sn-warp-tile rounded-xl p-8 md:p-10">
