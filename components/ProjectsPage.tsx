...
import { Layers, ArrowRight, User, Calendar, Globe } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {allProjects.map((project) => {
            ...
            return (
              <div
                key={project.id}
                className="group relative rounded-[2rem] md:rounded-[3rem] overflow-hidden border border-white/10 bg-[#050505] cursor-pointer transition-all duration-700 hover:border-white/20 hover:shadow-[0_0_60px_rgba(37,211,102,0.05)]"
              ...
              >
                ...
                <div className="p-8 md:p-10">
                  <h3 className="text-2xl md:text-3xl font-black uppercase text-white tracking-tighter leading-none mb-4 group-hover:text-[#25D366] transition-colors duration-500">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-[#25D366] group-hover:border-[#25D366] transition-all duration-500">
                      <ArrowRight size={16} className="text-white/40 group-hover:text-black transition-colors" />
                    </div>
                  </div>
                </div>
              </div>
