          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="space-y-12">
                  <div>
                      ...
                      <div className="absolute right-0 top-0 w-64 h-64 md:w-80 md:h-80 opacity-35 pointer-events-none">
                        <PixelGlobe scaleMultiplier={0.3} type="all" opacity={0.8} glowEnabled={true} largeParticles={true} />
                      </div>
