...
const routeMeta = {
  ...
  'gratis-website': {title: 'Gratis website aanvragen | SocialNow', description: 'Vraag je gratis website aan per e-mail of WhatsApp. Je gegevens staan alvast in het bericht.'},
  'gratis-os-demo': {title: 'Gratis OS-demo | SocialNow', description: 'Vraag een gratis demo van SocialNow OS aan met je naam en e-mailadres.'},
