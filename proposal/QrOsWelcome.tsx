...
const COPY: Record<Language, { close:string; welcome:string; explore:string; yes:string; no:string; eyebrow:string; nice:string; lead:string; items:[string,string,string]; first:string; last:string; email:string; submit:string; edit:string }> = {
 ...
 it:{close:"Chiudi benvenuto",welcome:"Benvenuto in SocialNow.",explore:"Vuoi scoprire l’OS?",yes:"Sì, mostramelo",no:"No, visita il sito",eyebrow:"IL TUO OS PERSONALE",nice:"Piacere di conoscerti.",lead:"Richiedi la demo OS gratuita direttamente su WhatsApp.",items:["I tuoi dati Odoo, pronti quando li colleghi","Un brand e uno Studio per la tua azienda","Team, lavoro e prossimi passi in un unico posto"],first:"Nome",last:"Cognome",email:"Indirizzo e-mail",submit:"Richiedi su WhatsApp",edit:"Puoi modificare il messaggio prima di inviarlo."},
 es:{close:"Cerrar bienvenida",welcome:"Bienvenido a SocialNow.",explore:"¿Quieres descubrir el OS?",yes:"Sí, muéstramelo",no:"No, visitar la web",eyebrow:"TU OS PERSONAL",nice:"Encantados de conocerte.",lead:"Solicita tu demo OS gratis directamente por WhatsApp.",items:["Tus datos de Odoo, listos cuando los conectes","Una marca y un Studio para tu empresa","Tu equipo, trabajo y próximos pasos en un solo lugar"],first:"Nombre",last:"Apellidos",email:"Correo electrónico",submit:"Solicitar por WhatsApp",edit:"Puedes editar el mensaje antes de enviarlo."},
};
